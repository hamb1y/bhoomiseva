...
const ROUTES = [
  ...
  ["event-detail", "/events/farmer-training-chirantana-2023", "desktop"],
  ["blogs", "/blogs", "desktop"],
  ["blogs-donors", "/blogs/donors", "desktop"],
  ["blogs-donees", "/blogs/donees", "desktop"],
  ["kn-events", "/kn/events", "desktop"],
  ["kn-blogs-donors", "/kn/blogs/donors", "desktop"],
  ["about", "/about", "desktop"],
